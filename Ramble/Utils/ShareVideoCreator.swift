...
//  Function to make a video from blank image and audio...
    
//  Function to add user information and layers to that video...

//    func MakeVideo(){
//        if let audioURL4 = Bundle.main.url(forResource: localFile , withExtension: mP4) {
//
...
// Create Video of Audio Length with Black Background
// Add Audio
// Add Text Items Layer
// Add Sound Animation Gif
// Save to CameraRoll as latest video
// Call upload to IG with the latest file
// Post to IG Stories
// Post to IG Feed
